      ...
      <form onSubmit={handleSubmit(handleReject)}>
        <CModalBody>
          <img
            ...
            alt="reject-icon"
          />
          <p className="modal-title color-red">Xác nhận không duyệt tin</p>
          <span className="modal-inform-reject">
            Chọn lý do không duyệt tin
          </span>
              ...
              <ul>
                ...
                <li>
                  <InputField
                    ...
                    disabled={reason === 'Khác' ? false : true}
                  />
                </li>
              </ul>
            </div>
              ...
              <ul>
                ...
                <li>
                  <InputField
                    ...
                    as="textarea"
                    placeholder="Nhập lý do"
                    disabled={reason === 'Khác2' ? false : true}
                  />
                </li>
              </ul>
            </div>
