                            ...
                            >
                                <ul className="timeline" id="timeline">
                                    <li>
                                        ...
                                        <div
                                            className="timelineWork"
                                            id="timelineWork"
                                        >
                                            <div className='timelineWork-schoolName' id="timelineWork-schoolName">{item.tentruonghoc}</div>
                                            <div>
                                                <div
                                ...
                                <ul className="timeline" id="timeline">
                                    <li>
                                        ...
                                        <div
                                            ...
                                            id="timelineWork"
                                        >
                                            <div className='timelineWork-schoolName' id="timelineWork-schoolName">{item.tencongty}</div>
                                            <div>
                                                <div
                                                    className="timelineDescription"
                                                    id="timelineDescription"
